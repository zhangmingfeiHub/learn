 ...
 * @author mingfei.z
 */
public class QueueCaseV3_Consumer3 {

	public static final Logger logger = LoggerFactory.getLogger(QueueCaseV3_Consumer3.class);
		...
		try {
			...
			channel.basicConsume(QUEUE_NAME_3, false, new DefaultConsumer(channel) {
				...
				public void handleDelivery(String consumerTag, Envelope envelope, BasicProperties properties,
					...
					logger.info("QueueCaseV3_Consumer3 接收消息={}", msg);
					
					channel.basicAck(envelope.getDeliveryTag(), false);
				}
			});
		} catch (Exception e) {
			logger.error("QueueCaseV3_Consumer3 消费消息异常", e);
		}
	}
}
