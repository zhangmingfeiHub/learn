 ...
 * @author mingfei.z
 */
public class QueueCaseV5_Product2_Topic {

	public static final Logger logger = LoggerFactory.getLogger(QueueCaseV5_Product2_Topic.class);
	
	public static final String EXCANGE_NAME = "exchange_valid_case_v5";
	public static final String ROUTING_KEY = "binding_key_valid_case_v5.B";
	...
	public static void main(String[] args) {
		try {
			...
			for (int i=1; i<=20; i++) {
				...
				logger.info("QueueCaseV5_Product2_Topic 生产发送消息={}", msg);
			}
			
			channel.close();
			conn.close();
		} catch (Exception e) {
			logger.error("QueueCaseV5_Product2_Topic 生产消息异常", e);
		}
	}
