...
public class ConsumerDirect1 {
	...
	private static final String QUEUE_NAME = "test_queue_exchange_direct1";
		...
		channel.basicConsume(QUEUE_NAME, autoAck, new DefaultConsumer(channel) {
			...
			public void handleDelivery(String consumerTag, Envelope envelope, BasicProperties properties, byte[] body)
				...
				try {
					...
					System.err.println("[1] recieve message: " + message);
				} catch (InterruptedException e) {
					System.err.println("[1] recieve message exception: " + e);
				} finally {
					channel.basicAck(envelope.getDeliveryTag(), true);
					System.err.println("[1] recieve message done.");
				}
			}
		});
	}
