 ...
 * @author mingfei.z
 */
public class QueueCaseV4_Consumer2 {

	public static final Logger logger = LoggerFactory.getLogger(QueueCaseV4_Consumer2.class);
	
	public static final String EXCANGE_NAME = "exchange_valid_case_v4";
	public static final String QUEUE_NAME = "queue_valid_case_v4_2";
		...
		try {
			...
			channel.basicConsume(QUEUE_NAME, false, new DefaultConsumer(channel) {
				...
				public void handleDelivery(String consumerTag, Envelope envelope, BasicProperties properties,
					...
					logger.info("QueueCaseV4_Consumer2 接收消息={}", msg);
					
					channel.basicAck(envelope.getDeliveryTag(), false);
				}
			});
		} catch (Exception e) {
			logger.error("QueueCaseV4_Consumer2 消费消息异常", e);
		}
	}
