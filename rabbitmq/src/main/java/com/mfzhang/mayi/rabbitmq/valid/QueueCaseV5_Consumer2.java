 ...
 * @author mingfei.z
 */
public class QueueCaseV5_Consumer2 {

	public static final Logger logger = LoggerFactory.getLogger(QueueCaseV5_Consumer2.class);

	public static final String EXCANGE_NAME = "exchange_valid_case_v5";
	public static final String QUEUE_NAME = "queue_valid_case_v5_2";
	public static final String BINDING_KEY = "*.C";
		...
		try {
			...
			channel.basicConsume(QUEUE_NAME, false, new DefaultConsumer(channel) {
				...
				public void handleDelivery(String consumerTag, Envelope envelope, BasicProperties properties,
					...
					logger.info("QueueCaseV5_Consumer2 接收消息={}", msg);
					
					channel.basicAck(envelope.getDeliveryTag(), false);
				}
			});
		} catch (Exception e) {
			logger.error("QueueCaseV5_Consumer2 消费消息异常", e);
		}
	}
